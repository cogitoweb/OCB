...
class PaymentAcquirerPayumoney(models.Model):
    ...
    def payumoney_form_generate_values(self, values):
        ...
        payumoney_values = dict(values,
                                ...
                                surl='%s' % urllib.parse.urljoin(base_url, '/payment/payumoney/return'),
                                furl='%s' % urllib.parse.urljoin(base_url, '/payment/payumoney/error'),
                                curl='%s' % urllib.parse.urljoin(base_url, '/payment/payumoney/cancel')
                                )
