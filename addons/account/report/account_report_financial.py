...
class ReportFinancial(models.AbstractModel):
    ...
    def _compute_account_balance(self, accounts):
        ...
        for account in accounts:
            res[account.id] = dict((fn, 0.0) for fn in list(mapping.keys()))
        if accounts:
            ...
            request = "SELECT account_id as id, " + ', '.join(list(mapping.values())) + \
                       " FROM " + tables + \
    ...
    def _compute_report_balance(self, reports):
        ...
        for report in reports:
            ...
            if report.type == 'accounts':
                ...
                for value in list(res[report.id]['account'].values()):
                    for field in fields:
